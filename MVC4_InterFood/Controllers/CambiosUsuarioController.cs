...
{
    public class CambiosUsuarioController : Controller
    {

        // Instancia del modelo Producto
        Models.CambioModel cambioModel = new CambioModel();
        ...
        {
            var objListaPedidos = cambioModel.ConsultarPedido(id, identificacion);
